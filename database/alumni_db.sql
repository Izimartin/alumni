...
INSERT INTO `alumnus_bio` (`id`, `title`, `firstname`, `middlename`, `lastname`, `gender`, `batch`, `course_id`, `email`, `connected_to`, `avatar`, `status`, `date_of_birth`, `employment_status`, `reg_number`, `nationality`, `local_government_area`, `state`, `date_created`) VALUES
(2, 'Mr', 'Mike', 'D', 'Williams', 'Male', 2009, 1, 'mwilliams@sample.com', 'My Company', '1602730260_avatar.jpg', 1, '1985-10-15', 'Employed', 'AB12345', 'American', 'Los Angeles', 'California', '2020-10-15 12:34:56');
...
INSERT INTO `schools` (`id`, `school`, `about`) VALUES
(1, 'BS Information Technology', 'Sample');
