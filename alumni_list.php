                    ...
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="">
                                ...
                                <p class="filter-txt">Title: <b><?php echo $row['title'] ?></b></p>
                                <p class="filter-txt">Gender: <b><?php echo $row['gender'] ?></b></p>
                                <p class="filter-txt">DOB: <b><?php echo $row['date_of_birth'] ?></b></p>
                                <p class="filter-txt">Nationality: <b><?php echo $row['nationality'] ?></b></p>
                                <p class="filter-txt">State: <b><?php echo $row['state'] ?></b></p>
                                <p class="filter-txt">L.G.A: <b><?php echo $row['local_government_area'] ?></b></p>
                                ...
                                <p class="filter-txt">Batch: <b><?php echo $row['batch'] ?></b></p>
                                 <p class="filter-txt">Employment Status: <b><?php echo $row['employment_status'] ?></b></p>
                                <p class="filter-txt">Employer: <b><?php echo $row['connected_to'] ?></b></p>
                                    <br>
                                </div>
                            </div>
                        </div>
