	...
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<p>Date of Birth: <b><?php echo $date_of_birth ?></b></p>
				<p>Nationality: <b><?php echo $nationality ?></b></p>
				<p>State: <b><?php echo $state ?></b></p>
				<p>L.G.A: <b><?php echo $local_government_area ?></b></p>
				
				
			</div>
			<div class="col-md-6">
				<p>Employment Status: <b><?php echo $employment_status ?></b></p>
				<p>Employer: <b><?php echo $connected_to ?></b></p>
