...
<style>
    ...
    <div class="row form-group">
        ...
        <div class="col-md-4">
            <label for="" class="control-label">Local Government Area (LGA)</label>
            <input type="text" class="form-control" name="local_government_area">
        </div>
    </div>
    <div class="row form-group">
                <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <input name="connected_to" id="" class="form-control"></input>
        </div>
        <div class="col-md-4">
