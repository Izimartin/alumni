                                ...
                                <div class="col-md-12">
                                    <form action="" id="update_account">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Year of Graduation</label>
                                                <input type="input" class="form-control datepickerY" name="year of graduation" value="<?php echo $_SESSION['bio']['year of graduation'] ?>" required>
                                            </div>
                                            <div class="col-md-4">
